        ...
        children: [
          ...
          _buildFilterSection(
            ...
            Wrap(
              ...
              runSpacing: 8,
              children: [
                _buildFilterChip('Cualquier Hora', 'anytime', Icons.access_time,
                    filterType: 'time'),
                _buildFilterChip('Desayuno', 'breakfast', Icons.free_breakfast,
                    filterType: 'time'),
                _buildFilterChip('Almuerzo', 'lunch', Icons.lunch_dining,
                    filterType: 'time'),
                _buildFilterChip('Cena', 'dinner', Icons.dinner_dining,
                    filterType: 'time'),
              ],
            ),
          ),
          ...
          _buildFilterSection(
            ...
            Wrap(
              ...
              runSpacing: 8,
              children: [
                _buildFilterChip('Cualquiera', 'anyone', Icons.people,
                    filterType: 'company', emoji: '✨'),
                _buildFilterChip('Citas', 'date', Icons.favorite,
                    filterType: 'company', emoji: '💕'),
                _buildFilterChip('Amigos', 'friends', Icons.group,
                    filterType: 'company', emoji: '👥'),
                _buildFilterChip('Familia', 'family', Icons.family_restroom,
                    filterType: 'company', emoji: '👨‍👩‍👧‍👦'),
              ],
            ),
          ),
